...
function ignoredFilesFilter(dir, file) {
  // TODO Filter out files according to the .featurebookignore file
  return file !== DEFAULT_METADATA_FILE_NAME
    && file !== DEFAULT_SUMMARY_FILE_NAME
    && file !== DEFAULT_IGNORE_FILE_NAME
    && file !== DEFAULT_ASSETS_DIR
    && file !== DEFAULT_DIST_DIR
    && file !== GIT_REPO_DIR;
}
